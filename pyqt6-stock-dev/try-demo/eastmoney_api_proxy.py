...
def get_realtime_ticks(stock_code):
    ...
    cookies = 'qgqp_b_id=230aff2e7da304d9f90998bdb87d3426; st_nvi=BpEZJjVriRfwliAw7DDh71b37; nid18=04a282e9f8b7b5340cef7a9451ac7e6e; nid18_create_time=1770097875415; gviem=TfFv6XL-gT3ndPeqPdryccd38; gviem_create_time=1770097875415; fullscreengg=1; fullscreengg2=1; st_si=03956223211737; st_asi=delete; st_pvi=85284089938564; st_sp=2024-05-19%2015%3A51%3A55; st_inirUrl=https%3A%2F%2Fguba.eastmoney.com%2F; st_sn=15; st_psi=20260226170456152-117001350220-3940072776'
    req.add_header("Cookie", cookies)
    print(url)
    response = urlrequest.urlopen(req,timeout=3)
    data=response.readline().decode('utf-8').lstrip('data:')
    data_json = json.loads(data)
