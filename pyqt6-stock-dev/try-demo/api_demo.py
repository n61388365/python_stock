...
def get_realtime_ticks(stock_code):
    ...
    stock_code = stock_code.startswith('0') and '0.{}'.format(stock_code) or '1.{}'.format(stock_code)
...
def get_transaction_details(stock_code):
    # 深证 0. + 000750，上证 1. + 601568
    stock_code = stock_code.startswith('0') and '0.{}'.format(stock_code) or '1.{}'.format(stock_code)
...
if __name__ == '__main__':
    stock = '000750'
    get_realtime_ticks(stock)
    get_transaction_details(stock)
