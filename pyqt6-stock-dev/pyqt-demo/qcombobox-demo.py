...
from PyQt6.QtWidgets import QWidget, QApplication, QGroupBox, QPushButton, QLabel, QCheckBox, QSpinBox, QHBoxLayout, QComboBox, QGridLayout
...
class SignalEmit(QWidget):
    ...
    def creatContorls(self,title):
        ...
        self.styleCombo = MyComboBox(self)
