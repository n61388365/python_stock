...
import pandas as pd
import time
from PyQt6.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QLineEdit, QPushButton, QTableWidget, QTableWidgetItem, QLabel, QHeaderView, QGridLayout, QCheckBox, QComboBox, QAbstractItemView
...
class TradeBlock(QWidget):
    def __init__(self, parent=None, stock_code='000750', stock_name='国海证券'):
        ...
        self.stock_label_name = QLabel(self.stock_name)
        ...
        self.stock_input.addItems(['600871 石化油服', '601568 北元集团', '601866 中远海发', '000750 国海证券'])
        self.stock_input.setPlaceholderText("例如: 601866")
        self.stock_input.setCurrentText(self.stock_code + ' ' + self.stock_name)
...
class TradeAnalyzer(QMainWindow):
    def __init__(self):
        ...
        self.block1 = TradeBlock(self, stock_code='000750', stock_name="国海证券")
