...
class TradeBlock(QWidget):
    def __init__(self, parent=None, stock=""):
        ...
        self.bid_table.setFixedHeight(95)
        ...
        self.result_table.setFixedHeight(134)
        ...
        self.detail_table.setFixedHeight(136)
    ...
    def update_detail_table_view(self):
        self.detail_table.setColumnCount(4)
        self.detail_table.setRowCount(len(self.df.tail(6)))
        for row_idx, row in enumerate(self.df.tail(6).iterrows()):
            str_time = str(row[1]['Time']).zfill(6)
    ...
    def update_order_book(self):
        ...
        try:
            ...
            self.order_book = None
            self.display_order_book()
            log.error(f"Error: Order book update failed. Error: {e}")
