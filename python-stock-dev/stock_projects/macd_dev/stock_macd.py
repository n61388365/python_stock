...
class StockMacd:
    def __init__(self, stock_code, freq_list=[5,30,60,101,102,103]):
    ...
    def _load_stock_data(self):
        ...
        # self.stock_data[90] = self.stock_data[5][self.stock_data[5].index%18 == 17].reset_index().drop('index',axis=1)
        ...
        # self.stock_data[102] = database_utils.load_A_stock_week_data(self.stock_code)
        # print(self.stock_data[90].to_string())
        # 收盘价
